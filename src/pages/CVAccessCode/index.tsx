...
import { useGetResumesQuery, useGetUserDataQuery, useGetUsersDataQuery, useGetWorkExperienceDescriptionsQuery } from "../../services/userApi";
...
function Main() {
  ...
  useEffect(() => {
    ...
    if(!access_code_user_data) {
      if (confirm("Invalid Access code. Please request the valid access code from the CV owner") == true) {
